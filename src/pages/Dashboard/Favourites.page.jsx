...
const Favourites = () => {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      const favRef = collection(db, `favorites/${user.uid}/movies`);
  ...
  }, [favorites, searchTerm, selectedYear, selectedGenre, selectedRating]);
  ...
  return (
    <DashboardLayout activeMenu="Favourites">
